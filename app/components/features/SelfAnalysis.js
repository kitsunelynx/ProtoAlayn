        ...
        <form onSubmit={sendMessage} className="max-w-4xl mx-auto p-4">
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 p-3 rounded-xl text-black border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
            />
            <motion.button
              type="submit"
